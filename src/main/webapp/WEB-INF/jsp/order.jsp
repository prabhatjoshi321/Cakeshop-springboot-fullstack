...
<!--         <li><a href="/popular">Top Purchases</a></li>
         <li><a href="/purchases">Top Purchaser</a></li> -->
	 		...
	 		<form action="/order" class="modal-content animate" style="padding-left:150px; padding-right:150px; padding-top:100px; padding-bottom:100px" method="POST">
			...
			<!--	 <div class="form-group" method="post" enctype="multipart/form-data">
              <label for="cakepic" >
			      	<input type="file" id="selectedFile" style="display: bold;" />
 					    <input type="button" value="Choose Your Own Cake..." onclick="document.getElementById('selectedFile').click();" />
              </Label>
           </div>    -->
